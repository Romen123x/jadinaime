const items = [
    'money', 'limit', 'bank', 'potion', 'trash', 'wood',
    'rock', 'string', 'emerald','diamond', 'gold',
    'iron', 'common','uncommon', 'mythic', 
    'legendary', 'pet', 'petFood', 'chip'
]
let confirmation = {}
...
example ${usedPrefix}${command} money 9999 @62895341999786
