...
const time = moment.tz('Asia/Jakarta').format('HH')
  ...
  m.reply(wait)
  await conn.reply(m.chat, `_*Downloading media from Tiktok*_`, 0, {
    contextInfo: {
        ...
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        ...
                        body: `⚘ ʙʏ ʀᴇɴᴢ`,                                       previewType: 0,
                        thumbnail: await (await fetch('https://telegra.ph/file/dddde01afab54e9b5a84e.jpg')).buffer(),
                        sourceUrl: 'https://chat.whatsapp.com/GPirbzqLVG1FrA25zcFAIG'
            }
        }
    })
}
