...
if (!isNumber(user.ayam)) user.ayam = 0
                ...
                if (!isNumber(user.lastmancings)) user.lastmancings = 0
                ...
                if (!isNumber(user.lastrokets)) user.lastrokets = 0
                ...
                if (!isNumber(user.lasttampokdm)) user.lastrampokdm = 0
                if (!isNumber(user.lastclaim))
                    user.lastclaim = 0
...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6285692672176', 'Ridwan', 'Creator Bot', 'Creator Bot', true],
